...
The map plots twelve Oxford Properties complexes across three provinces. At the default zoom Ontario, Alberta, and BC each appear as a regional cluster — zoom in to watch any cluster expand into individual building pins, then click a pin to see its address.

<Table
  data={{
    headers: [
      { content: "Complex", key: "complex" },
      { content: "City", key: "city" },
      { content: "Province", key: "province" },
      { content: "Type", key: "type" },
      { content: "Buildings", key: "buildings" },
    ],
    rows: [
      [<a key="rac" href="https://www.oxfordproperties.com/lease/complex/RAC" target="_blank" rel="noopener noreferrer">RAC</a>, "Toronto", "ON", "Office", "5"],
      [<a key="metroctr" href="https://www.oxfordproperties.com/lease/complex/METROCTR" target="_blank" rel="noopener noreferrer">MetroCentre</a>, "Toronto", "ON", "Office / Retail", "3"],
      [<a key="canadasq" href="https://www.oxfordproperties.com/lease/complex/CANADASQ" target="_blank" rel="noopener noreferrer">Canada Square</a>, "Toronto", "ON", "Office", "3"],
      [<a key="waterprk" href="https://www.oxfordproperties.com/lease/complex/WATERPRK" target="_blank" rel="noopener noreferrer">WaterPark Place</a>, "Toronto", "ON", "Office", "3"],
      [<a key="royal" href="https://www.oxfordproperties.com/lease/complex/ROYAL" target="_blank" rel="noopener noreferrer">Vaughan Industrial Park</a>, "Vaughan", "ON", "Industrial", "5"],
      [<a key="brmdisct" href="https://www.oxfordproperties.com/lease/complex/BRMDISCT" target="_blank" rel="noopener noreferrer">Brampton Business Park</a>, "Brampton", "ON", "Industrial", "5"],
      [<a key="jamessnow" href="https://www.oxfordproperties.com/lease/complex/JamesSnowBusinessPark" target="_blank" rel="noopener noreferrer">James Snow Business Park</a>, "Milton", "ON", "Industrial", "4"],
      [<a key="centennial" href="https://www.oxfordproperties.com/lease/complex/CENTENNIAL" target="_blank" rel="noopener noreferrer">Centennial Place</a>, "Calgary", "AB", "Office", "2"],
      [<a key="airporttrl" href="https://www.oxfordproperties.com/lease/complex/AIRPORTTRL" target="_blank" rel="noopener noreferrer">Oxford Airport Business Park</a>, "Calgary", "AB", "Industrial", "8"],
      [<a key="cityview" href="https://www.oxfordproperties.com/lease/complex/CITYVIEW" target="_blank" rel="noopener noreferrer">Cityview Business Park</a>, "Edmonton", "AB", "Industrial", "14"],
      [<a key="boyd501" href="https://www.oxfordproperties.com/lease/complex/501BOYD" target="_blank" rel="noopener noreferrer">Queensborough Logistics Park</a>, "New Westminster", "BC", "Industrial", "3"],
      [<a key="wiggins" href="https://www.oxfordproperties.com/lease/complex/WIGGINS" target="_blank" rel="noopener noreferrer">Riverbend Business Park</a>, "Burnaby", "BC", "Industrial", "6"],
    ],
  }}
/>
...
<p style={{ textAlign: "center", fontSize: "0.85em", marginTop: "0.5rem" }}>
  <a href="/demos/google-maps-clustering" target="_blank" rel="noopener noreferrer">Open standalone demo →</a>
</p>

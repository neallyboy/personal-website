...
The map below shows two Oxford Properties complexes — the [RAC complex](https://www.oxfordproperties.com/lease/complex/RAC) in Toronto's Financial District (5 office buildings) and the [Vaughan Industrial Park](https://www.oxfordproperties.com/lease/complex/ROYAL) (5 industrial buildings on Royal Group Crescent). At the default zoom both groups appear as separate clusters — zoom in to watch each cluster expand into individual building pins. Click any pin to see the building name and address.
